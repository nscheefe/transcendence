...
Generated by 'djangoi-admin startproject' using Django 3.2.16.
...
ALLOWED_HOSTS = ['0.0.0.0', 'localhost', '109.193.98.181']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'frontend_service', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
